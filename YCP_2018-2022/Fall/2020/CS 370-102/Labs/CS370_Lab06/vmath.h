...
public:
    ...
    inline matNM<T,h,w> inverse(void) const
    {
 		matNM<T,h,w> result;

 		// Compute determinant
 		T det = +data[3][0] * data[2][1] * data[1][2] * data[0][3] - data[2][0] * data[3][1] * data[1][2] * data[0][3]
		...
		result[0][0] = (+data[2][1] * data[3][2] * data[1][3] - data[3][1] * data[2][2] * data[1][3] + data[3][1] * data[1][2] * data[2][3]
				- data[1][1] * data[3][2] * data[2][3] - data[2][1] * data[1][2] * data[3][3] + data[1][1] * data[2][2] * data[3][3])/det;

		result[1][0] = (+data[3][0] * data[2][2] * data[1][3] - data[2][0] * data[3][2] * data[1][3] - data[3][0] * data[1][2] * data[2][3]
				+ data[1][0] * data[3][2] * data[2][3] + data[2][0] * data[1][2] * data[3][3] - data[1][0] * data[2][2] * data[3][3])/det;

		result[2][0] = (+data[2][0] * data[3][1] * data[1][3] - data[3][0] * data[2][1] * data[1][3] + data[3][0] * data[1][1] * data[2][3]
				- data[1][0] * data[3][1] * data[2][3] - data[2][0] * data[1][1] * data[3][3] + data[1][0] * data[2][1] * data[3][3])/det;

		result[3][0] = (+data[3][0] * data[2][1] * data[1][2] - data[2][0] * data[3][1] * data[1][2] - data[3][0] * data[1][1] * data[2][2]
				+ data[1][0] * data[3][1] * data[2][2] + data[2][0] * data[1][1] * data[3][2] - data[1][0] * data[2][1] * data[3][2])/det;

		result[0][1] = (+data[3][1] * data[2][2] * data[0][3] - data[2][1] * data[3][2] * data[0][3] - data[3][1] * data[0][2] * data[2][3]
				+ data[0][1] * data[3][2] * data[2][3] + data[2][1] * data[0][2] * data[3][3] - data[0][1] * data[2][2] * data[3][3])/det;

		result[1][1] = (+data[2][0] * data[3][2] * data[0][3] - data[3][0] * data[2][2] * data[0][3] + data[3][0] * data[0][2] * data[2][3]
				- data[0][0] * data[3][2] * data[2][3] - data[2][0] * data[0][2] * data[3][3] + data[0][0] * data[2][2] * data[3][3])/det;

		result[2][1] = (+data[3][0] * data[2][1] * data[0][3] - data[2][0] * data[3][1] * data[0][3] - data[3][0] * data[0][1] * data[2][3]
				+ data[0][0] * data[3][1] * data[2][3] + data[2][0] * data[0][1] * data[3][3] - data[0][0] * data[2][1] * data[3][3])/det;

		result[3][1] = (+data[2][0] * data[3][1] * data[0][2] - data[3][0] * data[2][1] * data[0][2] + data[3][0] * data[0][1] * data[2][2]
				- data[0][0] * data[3][1] * data[2][2] - data[2][0] * data[0][1] * data[3][2] + data[0][0] * data[2][1] * data[3][2])/det;

		result[0][2] = (+data[1][1] * data[3][2] * data[0][3] - data[3][1] * data[1][2] * data[0][3] + data[3][1] * data[0][2] * data[1][3]
				- data[0][1] * data[3][2] * data[1][3] - data[1][1] * data[0][2] * data[3][3] + data[0][1] * data[1][2] * data[3][3])/det;

		result[1][2] = (+data[3][0] * data[1][2] * data[0][3] - data[1][0] * data[3][2] * data[0][3] - data[3][0] * data[0][2] * data[1][3]
				+ data[0][0] * data[3][2] * data[1][3] + data[1][0] * data[0][2] * data[3][3] - data[0][0] * data[1][2] * data[3][3])/det;

		result[2][2] = (+data[1][0] * data[3][1] * data[0][3] - data[3][0] * data[1][1] * data[0][3] + data[3][0] * data[0][1] * data[1][3]
				- data[0][0] * data[3][1] * data[1][3] - data[1][0] * data[0][1] * data[3][3] + data[0][0] * data[1][1] * data[3][3])/det;

		result[3][2] = (+data[3][0] * data[1][1] * data[0][2] - data[1][0] * data[3][1] * data[0][2] - data[3][0] * data[0][1] * data[1][2]
				+ data[0][0] * data[3][1] * data[1][2] + data[1][0] * data[0][1] * data[3][2] - data[0][0] * data[1][1] * data[3][2])/det;

		result[0][3] = (+data[2][1] * data[1][2] * data[0][3] - data[1][1] * data[2][2] * data[0][3] - data[2][1] * data[0][2] * data[1][3]
				+ data[0][1] * data[2][2] * data[1][3] + data[1][1] * data[0][2] * data[2][3] - data[0][1] * data[1][2] * data[2][3])/det;

		result[1][3] = (+data[1][0] * data[2][2] * data[0][3] - data[2][0] * data[1][2] * data[0][3] + data[2][0] * data[0][2] * data[1][3]
				- data[0][0] * data[2][2] * data[1][3] - data[1][0] * data[0][2] * data[2][3] + data[0][0] * data[1][2] * data[2][3])/det;

		result[2][3] = (+data[2][0] * data[1][1] * data[0][3] - data[1][0] * data[2][1] * data[0][3] - data[2][0] * data[0][1] * data[1][3]
				+ data[0][0] * data[2][1] * data[1][3] + data[1][0] * data[0][1] * data[2][3] - data[0][0] * data[1][1] * data[2][3])/det;

		result[3][3] = (+data[1][0] * data[2][1] * data[0][2] - data[2][0] * data[1][1] * data[0][2] + data[2][0] * data[0][1] * data[1][2]
				- data[0][0] * data[2][1] * data[1][2] - data[1][0] * data[0][1] * data[2][2] + data[0][0] * data[1][1] * data[2][2])/det;
...
template <typename T>
static inline Tmat4<T> scale(const vecN<T,3>& v)
{
